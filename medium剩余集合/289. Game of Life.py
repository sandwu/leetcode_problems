...
class Solution(object):
    """
    Runtime: 24 ms, faster than 29.55% of Python online submissions for Game of Life.
    Memory Usage: 11.8 MB, less than 50.00% of Python online submissions for Game of Life.
    """
